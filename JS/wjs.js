...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/clouds.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/rainy.jpg)';
        ...
        document.body.style.backgroundImage = 'url(IMAGES/Weather/sunny.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/thunderstrom.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/mist.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(IMAGES/Weather/bg.jpg)';
    }
}
